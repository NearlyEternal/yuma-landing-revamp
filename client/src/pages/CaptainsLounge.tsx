        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-primary text-primary-foreground border-t border-white/20">
            <div className="container py-4 space-y-3">
              ...
              <a href="#" onClick={() => setMobileMenuOpen(false)} className="block hover:opacity-80 transition-opacity font-semibold py-2" style={{fontFamily: 'Play, sans-serif'}}>Captain's Lounge</a>
